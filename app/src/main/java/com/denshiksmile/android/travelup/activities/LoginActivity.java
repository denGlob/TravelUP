...
//        };
         ...
         *              REGISTER               *
         ***************************************/
        /* Load and setup the register activity button */
         ...
         **************************************/
        mEmailLoginView = (AutoCompleteTextView) findViewById(R.id.email);
        mPasswordLoginView = (EditText) findViewById(R.id.password);
    ...
    private class AuthResultHandler implements Firebase.AuthResultHandler {
        ...
        public void onAuthenticated(AuthData authData) {
            ...
            setAuthenticatedUser(authData);
            AuthDataProxyUtil authDataProxyUtil = new AuthDataProxyUtil();
            authDataProxyUtil.setAuthData(authData);
        }
    ...
    public void loginWithPassword() {
        ...
        String pass = mPasswordLoginView.getText().toString();
        mAuthProgressDialog.show();
        EmailPasswordUser user = new EmailPasswordUser();
        user.setEmail(email);
        user.setPassword(pass);
        user.autorizateAccount(mFirebaseRef);
    }
